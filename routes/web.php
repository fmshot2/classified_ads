...
Route::middleware(['cmo'])->group(function () { //CMO Middleware protection start here
    Route::get('/admin/dashboard/approve_withdrawal_request/{id}', 'DashboardController@approve_withdrawal_request')->name('admin.approve_withdrawal_request');
...
Route::middleware(['data'])->group(function () { //Data Entry Officer Middleware protection start here
