...
class SeekingWorkResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'still_studying'         => $this->still_studying == null ? '' : $this->still_studying,
            'gender'                 => $this->gender,
            'age'                    => $this->age,
            'marital_status'         => $this->marital_status == null ? '' : $this->still_studying,
            ...
            'work_experience'        => $this->work_experience == null ? '' : $this->work_experience,
            'education'              => $this->education,
            'certifications'         => $this->certifications == null ? '' : $this->certifications,
            'skills'                 => $this->skills,
            'status'                 => $this->status,
