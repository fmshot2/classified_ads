        ...
        <div class="row">
            <div class="col-xs-12">
                <div id="show_form" class="row clearfix">
                    <form action="{{route('provider.seeking.work.create')}}" method="POST" class="" enctype="multipart/form-data" style="display: block;">@csrf
                                ...
                                <div class="box-body">
                                    <div class="form-group file-upload" id="file-upload1">
                                        ...
                                        <div class="controls" style="display: none;">
                                            <input type="file" name="user_image" class="form-control show-tick" />
                                        </div>
                                    </div>
