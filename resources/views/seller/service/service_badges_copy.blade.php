                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <img class="profile-user-img img-responsive img-circle"
                                src="https://efcontact.com/img/verified-gold-512.png" alt="">
                            ...
                            <hr>
                            <img class="profile-user-img img-responsive img-circle"
                                src="https://efcontact.com/img/48025305-0-WhatsApp-Green-Tick.png" alt="">
                            ...
                            <ol>
                                ...
                                <li>Gain access to phone numbers of unlimited numbers of buyers</li>
                                <li>Appear beneath Trusted badge holders when buyers search for services related to yours
                                </li>
                            </ol>
                            <hr>
                            <img class="profile-user-img img-responsive img-circle"
                                src="https://efcontact.com/img/instagram-verified-logo-11549386033fpzr9vfugd.png" alt="">
                ...
                <div class="col-md-8">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a href="#timeline" data-toggle="tab" aria-expanded="true">Trusted Badge</a>
                            </li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="timeline">
                                <form class="form-horizontal form-element">
                                    ...
                                    <input type="hidden" name="seller_id1" id="seller_id1" value="{{ Auth::User()->id }}"
                                        class="form-control">
                                    <input type="hidden" name="badge_type1" id="badge_type1" value="Trusted"
                                        class="form-control">
                    ...
                    <select class="form-control"  name="service_id2">
                      ...
                      @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="seller_name1" class="form-control" name="seller_name1"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="email" class="form-control" name="email-address1"
                                                id="email-address1" value="{{ Auth::User()->email }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea type="text" class="form-control" name="address"
                                                id="address">{{ Auth::User()->address == null ? '' : Auth::User()->address }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <div class="checkbox">
                                                ...
                                                &nbsp;&nbsp;&nbsp;&nbsp;<a href="https://efcontact.com/terms-of-use">Terms
                                                    and Conditions</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            ...
                                            <button id="paystack_btn_control1" type="button" class="btn btn-warning"
                                                onclick="payWithPaystack1()"> MAKE PAYMENT </button>
  ...
  @endif --}}
                            ...
                            <div class="tab-pane" id="password">
                                ...
                                <form class="form-horizontal form-element">
                                    ...
                                    <input type="hidden" name="plan" id="plan" value="Trusted Seller" class="form-control">
                                    <input type="hidden" name="seller_id2" id="seller_id2" value="{{ Auth::User()->id }}"
                                        class="form-control">
                                    <input type="hidden" name="badge_type2" id="badge_type2" value="Verified"
                                        class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="seller_name2" class="form-control" name="seller_name2"
                                                value="{{ Auth::User()->name }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="email" class="form-control" name="email-address2"
                                                id="email-address2" value="{{ Auth::User()->email }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <script src="https://js.paystack.co/v1/inline.js"></script>
                                            <button id="paystack_btn_control2" type="button" class="btn btn-warning"
                                                onclick="payWithPaystack2()"> MAKE PAYMENT2 </button>
                            ...
                            <div class="tab-pane" id="verified">
                                <form class="form-horizontal form-element">
                                    ...
                                    <input type="hidden" name="plan" id="plan" value="Trusted Seller" class="form-control">
                                    <input type="hidden" name="seller_id3" id="seller_id3" value="{{ Auth::User()->id }}"
                                        class="form-control">
                                    <input type="hidden" name="badge_type3" id="badge_type3" value="Basic"
                                        class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="seller_name3" class="form-control" name="seller_name3"
                                                value="{{ Auth::User()->name }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="email" class="form-control" name="email-addres3"
                                                id="email-address3" value="{{ Auth::User()->email }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <script src="https://js.paystack.co/v1/inline.js"></script>
                                            <button id="paystack_btn_control3" type="button" class="btn btn-warning"
                                                onclick="payWithPaystack3()"> MAKE PAYMENT3 </button>
                ...
                callback: function(response) {
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            badge_type: badge_type3,
                            seller_name: seller_name3,
                            phone3: phone1,
                            ref_no: ref_no3
                        },
                        success: function(data) {
            ...
            $(".btn-submit4").click(function(e) {
                ...
                if (service_id == 0) {
                    ...
                    document.getElementById("error_msg_paystack1").innerHTML =
                        "Select a service before payment ";
