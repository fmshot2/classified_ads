                ...
                <div class="row filter-portfolio" style="width: 100%; margin-right: 0;margin-left: 0;">
                        ...
                        <div class="property-box">
                            <div class="property-thumbnail">
                                <a href="properties-details.html" class="property-img">
                                    <img class="d-block w-100" src="{{ asset('img/popular-places/lagos-1.jpg') }}" alt="properties">
                                </a>
                            </div>
                            <div class="detail">
                                <h1 class="title">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 filtr-item" data-category="3, 2, 1">
                        <div class="property-box">
                            <div class="property-thumbnail">
                                <a href="properties-details.html" class="property-img">
                                    <img class="d-block w-100" src="{{ asset('img/popular-places/portharcout-1.jfif') }}" alt="properties">
                                </a>
                            </div>
                            <div class="detail">
                                <h1 class="title">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 filtr-item" data-category="3, 2, 1">
                        <div class="property-box">
                            <div class="property-thumbnail">
                                <a href="properties-details.html" class="property-img">
                                    <img class="d-block w-100" src="{{ asset('img/popular-places/enugu-1.jfif') }}" alt="properties">
                                </a>
                            </div>
                            <div class="detail">
                                <h1 class="title">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 filtr-item" data-category="3, 2, 1">
                        <div class="property-box">
                            <div class="property-thumbnail">
                                <a href="properties-details.html" class="property-img">
                                    <img class="d-block w-100" src="{{ asset('img/popular-places/abuja-1.jpg') }}" alt="properties">
                                </a>
                            </div>
                            <div class="detail">
                                <h1 class="title">
