	...
	<div id="bannerCarousole" class="carousel slide" data-ride="carousel">
		<div class="carousel-inner">
			<div class="carousel-item banner-max-height active">
				<img class="d-block w-100" src="{{ asset('images/efcontactslider.png') }}" alt="banner">
...
Advertise Your Skills								</p>
			...
			<div class="carousel-item banner-max-height">
				<img class="d-block w-100" src="{{ asset('images/efphonetaxislider.png') }}" alt="banner">
				<div class="carousel-caption banner-slider-inner d-flex h-100 text-center">
					<div class="carousel-content container">
						<div class="text-center">
							{{-- <div class="text-sections">
...
Advertise your skills								</p>
							...
							<div class="btn-sections">
								...
								<a href="https://efphonetaxi.com" class="btn btn-lg btn-warning text-white" style="background-color: rgb(202, 131, 9); border: 2px solid #fff">Learn More</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="carousel-item banner-max-height">
				<img class="d-block w-100" src="{{ asset('images/efskyviewslider.png') }}" alt="banner">
				<div class="carousel-caption banner-slider-inner d-flex h-100 text-center">
					<div class="carousel-content container">
						<div class="text-center">
							{{-- <div class="text-sections">
...
Advertise your skills								</p>
							...
							<div class="btn-sections">
								<!--<a href="#" class="btn btn-lg btn-warning text-white">Get Started Now</a>-->
								<a href="https://efskyview.com" class="btn btn-lg btn-warning text-white" style="background-color: rgb(202, 131, 9); border: 2px solid #fff">Learn More</a>
							</div>
						</div>
					</div>
				</div>
