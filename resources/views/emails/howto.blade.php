...
{!! $message !!}
@if ($file_name != 'noimage')
<img src="{{ asset('uploads/emails/howto/'.$file_name) }}" alt="Info Image" style="width: 100%;padding:0;margin:0">
@endif
...
Please do not reply to this email. Having trouble viewing this message? <a href="{{ asset('uploads/emails/howto/'.$file_name) }}" target="_blank" rel="noopener noreferrer">Open this message in your browser</a>
