...
<h3 style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3d4852; font-size: 19px; font-weight: bold; margin-top: 0; text-align: center;">Hello, Michael Enoch!</h3>
...
<h4 style="font-size: 18px; margin-bottom: -30px;padding-left:20px;color:#CA8309;text-transform:uppercase">Job Applicants</h4>
<div class="table" style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;"></div>
    ...
    <tr>
    <td style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #74787e; font-size: 15px; line-height: 18px; margin: 0; padding: 15px; width: 50%;">
        ...
        <div>
            <h4>Service Name</h4>
            <p style="font-size: 12px;margin-top: -18px">Lagos, Ikeja</p>
            <p style="font-size: 16px;margin-top: -10px;font-weight:600;">&#8358; 400,000</p>
        </div>
        <a href="{{ route('serviceDetail', ['slug' => 'job-applicant']) }}" class="button button-primary" target="_blank" rel="noopener" style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #ca8309; border-bottom: 8px solid #ca8309; border-left: 18px solid #ca8309; border-right: 18px solid #ca8309; border-top: 8px solid #ca8309;margin-top: -5px;">View Service</a></div>
    </td><td align="left" style="box-sizing: border-box;font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';position: relative;color: #74787e;font-size: 15px;line-height: 18px;margin: 0;padding: 10px 0;text-align: left;width: 50%;padding: 15px">
       <div><div style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 100%; width: 100%; background-image: url('{{asset('uploads/services/1606900695.jpeg')}}');display: block;height: 200px;width: auto;background-size: cover !important;background-position: center !important;"></div>
       <div>
           <h4>Service Name</h4>
           <p style="font-size: 12px;margin-top:-18px;">FCT, Abuja</p>
           <p style="font-size: 16px;margin-top:-10px;font-weight:600;">&#8358; 50,000</p>
       </div>
       <a href="{{ route('serviceDetail', ['slug' => 'job-applicant']) }}" class="button button-primary" target="_blank" rel="noopener" style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #ca8309; border-bottom: 8px solid #ca8309; border-left: 18px solid #ca8309; border-right: 18px solid #ca8309; border-top: 8px solid #ca8309;margin-top: -5px;">View Service</a></div>
    </td>
    </tr>
