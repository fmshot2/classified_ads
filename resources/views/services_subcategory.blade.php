                    ...
                    <div class="col-lg-9 col-md-12 col-xs-12 jobApSerDesktop">
                        <div class="row">
                            @forelse($category_services as $category_service)
                                        ...
                                        <div class="property-box">
                                            ...
                                            <div class="detail">
                                                ...
                                                <ul class="d-flex flex-row justify-content-between info">
                                                    <li>
                                                        <i class="fa fa-thumbs-up text-warning" aria-hidden="true" style="font-size: 11px;"></i> {{$category_service->views->count()}} View{{$category_service->views->count() > 1 ? 's' : ''}}
                                                    </li>
                                                    <li>
                                ...
                                @endif
                            @empty
                                <h4 class="text-muted text-center">There are no services yet within this category</h4>
                            @endforelse
                        </div>
                    </div>
