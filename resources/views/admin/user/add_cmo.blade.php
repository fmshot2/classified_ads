                        ...
                        <div class="form-layout">
                            <div class="row mg-b-25">
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <form class="form-horizontal form-element" method="POST" action="{{route('admin.submit.cmo')}} " enctype="multipart/form-data">
                                        {{ csrf_field() }}

                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="site_name" class="control-label">Name</label>
                                                <input type="text" name="name" id="site_name" class="form-control" autofocus="" placeholder="Name of CMO" value="{{ old('name') }}">
                                            </div>
                                            @if ($errors->has('name'))
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="email" id="site_name" class="form-control" autofocus="" placeholder="Email Address of CMO" value="{{ old('email') }}">
                                    ...
                                    <div class="col-lg-12">
                                        <button type="submit" class="btn btn-warning btn-sm"> Add CMO </button>
                                    </div>
