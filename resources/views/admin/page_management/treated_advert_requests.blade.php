        ...
        <div class="box">
          ...
          <div class="box-body">
            <table id="example" class="table table-bordered table-hover display nowrap margin-top-10 dataTable no-footer">
              ...
              <tbody>
                             @forelse ($treated_advert_requests as $treated_advert_request)
                             <tr>
                    <th>{{$treated_advert_request->seller_name}}</th>
                    <th>{{$treated_advert_request->email}}</th>
                    <th>{{$treated_advert_request->phone}}</th>
                    <th>{{$treated_advert_request->category}}</th>
@empty
