    ...
    <div id="modaldemo1" class="modal fade">
        <div class="modal-dialog modal-dialog-vertical-center" role="document">
          <div class="modal-content bd-0 tx-14">
            ...
            <div class="modal-body pd-25">
            <form id="pharmCreate" action="{{route('superadmin.save_faq')}}" method="POST" enctype="multipart/form-data">
                                         {{ csrf_field() }}
      ...
      <div id="modaldemo1" class="modal fade">
        <div class="modal-dialog modal-dialog-vertical-center" role="document">
          <div class="modal-content bd-0 tx-14">
            ...
            <div class="modal-body pd-25">
            <form id="pharmCreate" action="{{route('cmo.save_faq')}}" method="POST" enctype="multipart/form-data">
                                         {{ csrf_field() }}
