        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form id="aboutForm" action="{{route('superadmin.pagescontents.save.privacy')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                    ...
                    <div class="box-body">
                        <form id="aboutForm" action="{{route('cmo.pagescontents.save.privacy')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <textarea name="privacy_policy" class="form-control summernote" rows="15" value="{{ $pages_contents_page == 0 ? $pages_contents->privacy_policy : ''  }}" style="border: 1px solid #d2d6de; padding: 10px">
                                    {{ $pages_contents_page == 0 ? $pages_contents->privacy_policy : ''  }}
