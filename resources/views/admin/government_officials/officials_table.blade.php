                ...
                @forelse($officials as $key => $official)
                    <tr>
                        ...
                        <td class="center">
                            ...
                            <a href="{{ route('superadmin.delete.official',$official->id) }} " class="btn btn-danger "><i class="fa fa-trash"></i></a>
                            ...
                            <a href="{{ route('cmo.delete.official',$official->id) }} " class="btn btn-danger "><i class="fa fa-trash"></i></a>
                            @else
                            @endif
                        </td>
                    </tr>
                    ...
                    <div id="official{{ $official->id }}InfoModal" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <form action="{{ route('superadmin.government.update', ['id' => $official->id]) }}" method="post" enctype="multipart/form-data">
                                    @method('put')
                                    @csrf
                    ...
                    <div id="official{{ $official->id }}InfoModal" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <form action="{{ route('cmo.government.update', ['id' => $official->id]) }}" method="post" enctype="multipart/form-data">
                                    @method('put')
                                    @csrf
                                    <div class="modal-body">
                                        <div class="row">
