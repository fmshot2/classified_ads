                                                    ...
                                                    @if (isset($advertisements))
                                                        @foreach($advertisements as $key => $adslider)
                                                            <tr>
                                                                ...
                                                                <td>{{ $adslider->location_name }}</td>
                                                                <td>{{ $adslider->brand_name }}</td>
                                                                <td>{{ $adslider->client_name }}</td>
                                                                <td>{{ $adslider->client_phone }}</td>
                                                                <td>{{ date('d M Y', strtotime($adslider->start_date)) }}</td>
                                                                <td>{{ date('d M Y', strtotime($adslider->end_date)) }}</td>
